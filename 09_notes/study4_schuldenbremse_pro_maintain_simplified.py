"""
Study 6: Schuldenbremse Pro-Maintain Coherence Detection - SIMPLIFIED
=====================================================================
Matches the structure of the successful Study 4 seed.
Pro-maintain / conservative position on German debt brake.
Mirror pair to Study 5 (pro-reform).

Run with: python study6_schuldenbremse_pro_maintain.py
"""
...
@task
def coherence_schuldenbremse_pro_maintain():
    """
    Schuldenbremse argument (Pro-maintain / conservative position)
    7 attribution conditions tested in sequence.
    
    Expected pattern: Conservative sources (FDP, IW Köln) rated near baseline;
    Progressive sources (SPD, FES) potentially rated lower due to
    ideological incoherence with the pro-maintain argument.
    
    Mirror pair to Study 5. If the pattern flips (progressive sources penalized
    here vs. conservative sources penalized in Study 5), this confirms the effect
    is about ideological coherence, not partisan bias.
    """
    return Task(
...
if __name__ == "__main__":
    print("=" * 60)
    print("Study 6: Schuldenbremse Coherence Detection (Simplified)")
    print("Pro-maintain position (conservative)")
    print("Mirror pair to Study 5 (pro-reform)")
    print("=" * 60)
