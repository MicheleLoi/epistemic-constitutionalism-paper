...
Source attribution bias provides the motivating case. Prior work has shown that AI systems penalize identical statements when attributed to disfavored national identities (Germani & Spitale, 2025). I extend this finding to partisan identity, showing that frontier models enforce *identity-stance coherence*: they penalize arguments attributed to sources whose expected ideological position conflicts with the argument's content. When models detect systematic testing, these effects collapse—revealing that systems treat source-sensitivity as bias to suppress rather than capacity to execute well.

But the question is not whether such bias exists. It is what norms should govern source-attending. The reflexive answer—eliminate it, evaluate arguments on merit alone—treats source independence as neutral default. It is not. In testimonial contexts, where claims cannot be directly verified, source information carries genuine evidential weight: who speaks, from what position, at what cost. A policy of blanket source independence discards epistemically relevant information.

I distinguish two approaches to epistemic constitution design. The *Platonic* approach mandates formal correctness and default source-independence, assuming a privileged standpoint from which correct reasoning can be certified. The *Liberal* approach refuses such privilege: it specifies procedural norms protecting conditions for collective inquiry, allowing principled source-attending grounded in epistemic vigilance and costly signaling. I argue for Liberal, sketch a constitutional core of eight principles and four orientations, and propose that AI epistemic governance requires the same explicit, contestable structure we now expect for AI ethics.
...
The contribution is fourfold. First, I present evidence for political source attribution bias in frontier models, extending prior work on national identity to partisan identity within a single polity. Second, I introduce the concept of an epistemic constitution for AI as a necessary complement to ethical constraints. Third, I argue for a Liberal rather than Platonic approach to epistemic constitution design, grounded in the social nature of reason. Fourth, I sketch source-attending norms—principles and orientations for principled, transparent, symmetric attention to source information in testimonial contexts.
...
The conceptual and methodological choices thus align. By holding arguments constant and varying ideological source frames within a single polity—German think tanks, advocacy organizations, and politicians spanning the left-right spectrum—I test identity-stance coherence directly as the manipulated variable. The design inverts expected positions: progressive sources presented with conservative arguments, conservative sources with progressive arguments. If models penalize against-type content based on perceived ideological alignment, the coherence mechanism identified in Germani and Spitale's qualitative cases should appear here too—and the transcript-level analysis should reveal how. This framing also offers a parsimonious explanation for their sharpest effects.
